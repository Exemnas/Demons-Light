...
extern LPDIRECTINPUTDEVICE8 dinputdev;
...
void FontPrintsprite(LPD3DXFONT font, int x, int y, string text, D3DCOLOR color = D3DCOLOR_XRGB(255,255,255));
void FontPrint(LPD3DXFONT font, int fontx, int fonty, string text, D3DCOLOR color = D3DCOLOR_XRGB(255,255,255));